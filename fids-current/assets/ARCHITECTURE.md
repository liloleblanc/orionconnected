# FIDS — How This Is Built (read before changing anything)

This is the rulebook for the new system. The old system (`fids-v219`) is kept
as evidence, not as a base. It is a record of **what rots and what works.**
If you only read one thing, read **The One Rule.**
...
- One giant file that knows every specific (the 20k-line core).
...
> Two viewer/admin codebases that drift apart is exactly the old mistake
> (`fids-core.js` + `fidscore.js`). One system, role-gated. Access routes you.
