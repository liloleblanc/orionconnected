(function () {
  ...
  function markGeneratedSurroundLayers(media) {
    ...
    // The silver frame deliberately sits IN FRONT of the advert (decided
    // Jul 26 2026) — the old safe-zone mask here is exactly what kept
    // erasing it over the ad.
  }
  ...
  // stalls to match. That is the bump that is visible on screen but hard to point at.
  //
