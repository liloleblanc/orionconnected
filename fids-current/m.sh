...
#
#   bash m.sh 1            # the radiomast reference feed (what it plays now)
#   bash m.sh off          # no music — silent audio track
#   bash m.sh <stream-url> # any direct Icecast / SHOUTcast / .mp3 stream
#
...
case "${1-}" in
  "")   echo; echo "  Usage:  bash m.sh 1   |   bash m.sh off   |   bash m.sh <url>"; echo
