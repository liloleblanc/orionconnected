# IATA Aircraft Type Codes — reference

Authoritative IATA aircraft type-code list (IATA code → ICAO code → manufacturer /
model → WTC wake-turbulence category). **This is the source of truth** for the
`IATA_AIRCRAFT` label table and the `aircraftCodeToIata` `_REMAP` in
`js/fids-core.js`. When adding or correcting an equipment-code mapping, check it
here first — e.g. this list is what showed `32B` = A321-200 (Sharklets), not an
A320, and `32A` = A320 (Sharklets), not an A319.

Note the Airbus sharklet family: `32A` = A320 sharklets, `32B` = A321 sharklets,
`32C` = A318 sharklets, `32D` = A319 sharklets; the neos are `32N` (A320neo) and
`32Q` (A321neo). Air Canada flies the sharklet **A321** (`32B`).

WTC: L = Light, M = Medium, H = Heavy, J = Super (A380).

| IATA | ICAO | Manufacturer & Type / Model | WTC |
|------|------|------------------------------|-----|
...
| 290 | E290 | Embraer E190-E2 | M |
| 295 | E295 | Embraer E195-E2 | M |
| 221 | BCS1 | Airbus A220-100 | M |
| 223 | BCS3 | Airbus A220-200 | M |
| 310 | A310 | Airbus A310 all pax models | H |
| 312 | A310 | Airbus A310-200 pax | H |
| 313 | A310 | Airbus A310-300 pax | H |
| 318 | A318 | Airbus A318 | M |
| 319 | A319 | Airbus A319 Ceo | M |
| 31F | A310 | Airbus A310 Freighter | M |
| 31N | A19N | Airbus A319 Neo | M |
| 31X | A310 | Airbus A310-200 Freighter | M |
| 31Y | A310 | Airbus A310-300 Freighter | M |
| 320 | A320 | Airbus A320-100/200 Ceo | M |
| 321 | A321 | Airbus A321-100/200 Ceo | M |
| 32A | A320 | Airbus A320-200 Ceo (Sharklets) | M |
| 32C | A318 | Airbus A318 (Sharklets) | M |
| 32D | A319 | Airbus A319 Ceo (Sharklets) | M |
| 32N | A20N | Airbus A320-200 Neo | M |
| 32Q | A21N | Airbus A321-200 Neo | M |
| 32S | n/a | Airbus A318/319/320/321 | M |
| 330 | A330 | Airbus A330 all models | H |
| 332 | A332 | Airbus A330-200 | H |
| 333 | A333 | Airbus A330-300 | H |
|  | A337 | Airbus A330-700 Beluga XL | H |
| 338 | A338 | Airbus A330-800 Neo | H |
| 339 | A339 | Airbus A330-900 Neo | H |
| 33X | A332 | Airbus A330-200 Freighter | H |
...
| 351 | A35K | Airbus A350-1000 | H |
| 359 | A359 | Airbus A350-900 | H |
| 380 | A388 | Airbus A380 pax | J |
| 38F |  | Airbus A380 Freighter | J |
...
| 72W | B721 | Boeing 727-200 (winglets) pax | M |
...
| 73C | B733 | Boeing 737-300 (winglets) pax | M |
| 73E | B735 | Boeing 737-500 (winglets) pax | M |
| 73F | n/a | Boeing 737 all Freighter models | M |
| 73G | B737 | Boeing 737-700 pax | M |
| 73H | B738 | Boeing 737-800 (winglets) pax | M |
| 73J | B739 | Boeing 737-900 (winglets) pax | M |
| 73L | B732 | Boeing 737-200 Combi | M |
| 73M | n/a | Boeing 737 Combi | M |
| 73P | B734 | Boeing 737-400 Freighter | M |
| 73Q | B734 | Boeing 737-400 Combi | M |
| 73R | B737 | Boeing 737-700 Combi | M |
...
| 748 | B748 | Boeing 747-8 pax | H |
| 74B | B744 | Boeing 747-400 Swingtail Freighter | H |
...
| 75T | B753 | Boeing 757-300 (winglets) pax | H |
| 75W | B752 | Boeing 757-200 (winglets) pax | H |
...
| 76W | B763 | Boeing 767-300 (winglets) pax | H |
| 76V | B763 | Boeing 767-300 (winglets) Freighter | H |
...
| 77L | B772 | Boeing 777-200LR pax | H |
| 77W | B77W | Boeing 777-300ER pax | H |
| 77X | B77L | Boeing 777-200 Freighter | H |
| 781 | B78X | Boeing 787-10 pax | H |
| 788 | B788 | Boeing 787-8 pax | H |
| 789 | B789 | Boeing 787-9 pax | H |
| 7M7 | B37M | Boeing 737 MAX 7 pax | M |
| 7M8 | B38M | Boeing 737 MAX 8 pax | M |
| 7M9 | B39M | Boeing 737 MAX 9 pax | M |
| 7MJ | B3XM | Boeing 737 MAX 10 pax | M |
| A22 | AN22 | Antonov AN-22 | L |
| A26 | AN26 | Antonov AN-26 | L |
| A28 | AN28 | Antonov AN-28 / PZL Miele M-28 Skytruck | L |
| A30 | AN30 | Antonov AN-30 | L |
| A32 | AN32 | Antonov AN-32 | L |
| A38 | AN38 | Antonov AN-38 | L |
| A40 | A140 | Antonov AN-140 | M |
| A4F | A124 | Antonov AN-124 Ruslan | H |
| A5F | A225 | Antonov AN-225 | H |
| A81 | A148 | Antonov AN-148-100 | M |
...
| ATD | AT44 | Aerospatiale/Alenia ATR 42-400 | M |
| ATF | AT72 | Aerospatiale/Alenia ATR 72 Freighter | M |
...
| BES | B190 | Beechcraft 1900/1900C | M |
...
| CN7 | C750 | Cessna 750 Citation X | M |
...
| CRA | CRJ9 | Canadair Regional Jet 705 | M |
| CRF | n/a | Canadair Regional Jet Freighter | M |
| CRJ | n/a | Canadair Regional Jet | M |
| CRK | CRJX | Canadair Regional Jet 1000 | M |
| CRV | S210 | Aerospatiale (Sud Aviation) Se.210 Caravelle | M |
| CS1 | BCS1 | Bombardier C Series CS100 | M |
| CS2 | C212 | CASA / IPTN 212 Aviocar | M |
| CS3 | BCS3 | Bombardier C Series CS300 | M |
| CS5 | CN35 | CASA / IPTN CN-235 | M |
| CV2 | CVLP | Convair CV-240 pax | M |
...
| E75 | E75S | Embraer 175 (Short wing) | M |
| E75 | E75L | Embraer 175 (Long Wing) | M |
| E90 | E190 | Embraer 190 | M |
| E95 | E195 | Embraer 195 | M |
| EC3 | EC30 | Eurocopter EC.130 | n/a |
| EM2 | E120 | Embraer EMB.120 Brasilia | L |
| EMB | E110 | Embraer EMB.110 Bandeirante | M |
| EMJ | n/a | Embraer 170/190 | M |
| ER3 | E135 | Embraer RJ135 | M |
| ER3 | E35L | Embraer Legacy 600 / Legacy 650 | M |
| ER4 | E145 | Embraer RJ145 Amazon | M |
| ERD | n/a | Embraer RJ140 | M |
...
| H25 | n/a | British Aerospace (Hawker Siddeley) HS.125 | M |
...
| J31 | JS31 | British Aerospace Jetstream 31 | L |
...
| ND2 | N262 | Aerospatiale (Nord) 262 | M |
...
| PA1 | n/a | Piper light aircraft - single piston engine | L |
...
| RFS | n/a | Road Feeder Service - Cargo Truck | n/a |
| S20 | SB20 | Saab 2000 | M |
| S58 | S58T | Sikorsky S-58T | n/a |
| S61 | S61 | Sikorsky S-61 | n/a |
| S76 | S76 | Sikorsky S-76 | n/a |
| SF3 | SF34 | Saab SF340 | M |
| SFB | SF34 | Saab SF340B | M |
| SFF | SF34 | Saab SF340 Freighter | M |
...
| SU1 |  | Sukhoi Superjet 100 | M |
| SU7 |  | Sukhoi Superjet 100-75 | M |
| SU9 | SU95 | Sukhoi Superjet 100-95 | M |
| SWM | n/a | Fairchild (Swearingen) SA26 / SA226 / SA227 Metro / Merlin / Expediter | L |
| T20 | T204 | Tupolev Tu-204 / Tu-214 | M |
| T2F | T204 | Tupolev Tu-204 Freighter | M |
| TRN | n/a | Train | n/a |
| TU3 | T134 | Tupolev Tu134 | M |
| TU5 | T154 | Tupolev Tu154 | M |
| VCV | VISC | Vickers Viscount | M |
| WWP | WW24 | Israel Aircraft Industries 1124 Westwind | M |
| YK2 | YK42 | Yakovlev Yak 42 | M |
